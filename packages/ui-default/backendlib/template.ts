...
import { findFileSync, getAlphabeticId, getContestProblemConfig } from '@hydrooj/utils/lib/utils';
import {
...
class Nunjucks extends nunjucks.Environment {
  constructor(Loader: any) {
    ...
    this.addGlobal('utils', { status, getAlphabeticId, getContestProblemConfig });
