...
// TODO: Change the name of DESCRIPTORS before merge the PR. Also see `./setting.ts`.
export const DESCRIPTORS = {
    // * Based on `Hydro 需求说明清单 20230721`
    题目类型: ["编程题", "选择题", "判断题", "填空题", "材料题"],
    难度: ["全部", "入门", "CSP-J(-)", "CSP-J", "CSP-J(+)", "CSP-S(-)", "CSP-S", "CSP-S(+)", "NOIP", "省选", "NOI", "IOI"],
    标签类型: {
        CSP第一轮: [
            "CSP-J第一轮",
            "计算机基础",
