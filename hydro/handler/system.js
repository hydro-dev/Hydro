...
async function apply() {
    Route('/system', module.exports.SystemDashboardHandler);
    Route('/system/module', module.exports.SystemModuleHandler);
    Route('/system/setting', module.exports.SystemSettingHandler);
}
